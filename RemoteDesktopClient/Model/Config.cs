...
namespace RemoteDesktopClient.Model
{
    class Config
    {
        ...
        public Config(string remoteHost, int remotePort, string remoteUser, string remotePass, string remoteName, List<int> alternativePorts)
        {
